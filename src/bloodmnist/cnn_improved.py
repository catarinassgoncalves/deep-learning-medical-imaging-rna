...
val_accs = []
best_val_acc = 0.0
best_model_path = "best_bloodmnist_improved_model.pth"
...
plot_metric(train_losses, ylabel='Loss', name='CNN-improved-training-loss')
plot_metric(val_accs, ylabel='Accuracy', name='CNN-improved-validation-accuracy')